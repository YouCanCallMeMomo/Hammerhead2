  ...
  const t = {
    en: {
      ...
      cards: [
        ...
        { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14', title: 'PADI & SSI Certified — Verifiable and Trusted', body: 'My PADI OWSI (#465559) and SSI Divemaster Instructor (#56293) certifications are publicly verifiable. Confirm my credentials before you even contact me. Your safety is always the first priority.' },
    ...
    id: {
      ...
      cards: [
        ...
        { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14', title: 'Tersertifikasi PADI & SSI — Terverifikasi dan Terpercaya', body: 'Sertifikasi PADI OWSI (#465559) dan SSI Divemaster Instructor (#56293) saya dapat diverifikasi secara publik. Konfirmasi kredensial saya sebelum menghubungi.' },
    ...
    de: {
      ...
      cards: [
        ...
        { icon: 'M22 11.08V12a10 10 0 1 1-5.93-9.14', title: 'PADI & SSI zertifiziert — Verifizierbar und vertrauenswürdig', body: 'Meine Zertifizierungen als PADI OWSI (#465559) und SSI Divemaster Instructor (#56293) sind öffentlich überprüfbar. Bestätigen Sie meine Qualifikationen, bevor Sie mich kontaktieren.' },
